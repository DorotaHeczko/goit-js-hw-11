...
const axiosEl = (0, _axiosDefault.default).default;
...
const letSreach = async (e)=>{
    ...
    const search1 = searchQuery.value;
    try {
        const response = await axiosEl.get(`https://pixabay.com/api/?key=36135097-9ce084688f13669976d3cf799&q=${search1}&image_type=photo&orientation=horizontal&safesearch=true&per_page=40&page=${number}`);
...
function makePhoto(response) {
    ...
    const card = photoEl.map((photo)=>`<div class="photo-card">
    ...
    } else galleryEl.insertAdjacentHTML("beforeend", card);
    ...
    const lightboxOpen = new (0, _simplelightboxDefault.default)(".photo-card a", {
        captionsData: "alt",
...
},{"notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./css/styles.css":"1CY4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"kaxSc":[function() {},{}],"1CY4s":[function() {},{}],"gkKU3":[function(require,module,exports) {
